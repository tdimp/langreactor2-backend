...
deck_1.cards.create!(foreign_language: "Spanish", primary_lang_txt: "English Test", foreign_lang_txt: "Prueba de Español", img_url: "https://www.eyeonspain.com/userfiles/image/mac75/%C3%B1.jpg", user_id: 1)
...
deck_3.cards.create!(foreign_language: "English", primary_lang_txt: "Deutschland", foreign_lang_txt: "Germany", img_url: "https://wwwnc.cdc.gov/travel/images/map-germany.png", user_id: 2)
deck_3.cards.create!(foreign_language: "English", primary_lang_txt: "The car", foreign_lang_txt: "Das Auto", img_url: "http://onscreencars.com/content/uploads/2010/02/waynes_world_pacer.jpg", user_id: 2)

join_card = deck_1.cards.create!(foreign_language: "Test", primary_lang_txt: "Join Test", foreign_lang_txt: "TEST TEST TEST", img_url: "https://i.stack.imgur.com/VkAT5.png", user_id: 1)
